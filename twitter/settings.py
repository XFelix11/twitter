...
SECRET_KEY = '&vl-zsqsz%=t2#%-_-&k8x_7z%0qim&bcq+6^*wz3t_^1g#n!8'
...
ALLOWED_HOSTS = ['127.0.0.1', '192.168.1.174', 'localhost', '0.0.0.0']
...
AWS_STORAGE_BUCKET_NAME = 'felix-version-twitter'
